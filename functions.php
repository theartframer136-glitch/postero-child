...
add_action('wp_enqueue_scripts', function() {
    ...
    wp_enqueue_style('postero-child-custom', get_stylesheet_directory_uri() . '/assets/css/custom.css', array('postero-child'), '1.5.7');
    ...
    function buildFromItems(container, items) {
        ...
        var circles = videoData.map(function(v) {
            ...
            if (v.id) {
                ...
                img.alt = '';
                img.style.cssText = 'position:absolute;inset:-12%;width:124%;height:124%;object-fit:cover;';
                img.onerror = function(){ this.src='https://img.youtube.com/vi/'+v.id+'/hqdefault.jpg'; this.onerror=null; };
                circle.appendChild(img);
