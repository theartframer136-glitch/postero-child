 ...
 * ================================================================ */
foreach (array('abandoned-cart', 'address-validation', 'fraud-detection', 'documents', 'marketplace', 'shipping', 'reels', 'cookie-consent', 'masonry', 'orientation-filter', 'blog-hub', 'analytics', 'live-chat', 'sales-count', 'review-enhancements', 'artist-profiles', 'banner-links') as $af_mod) {
